...
const TRANSLATIONS = {
    en: {
        ...
        'account.copy': 'Use your account to save identity and global scores, or continue as a guest for this session.',
        ...
        'account.message.itchGuest': 'Itch version: online leaderboard is active in guest mode.',
        ...
        'account.message.itchGuestOnly': 'On itch, the online leaderboard uses guest mode.',
        ...
        'debug.slowCameraOn': 'SLOW CAMERA ON',
        'debug.slowCameraOff': 'SLOW CAMERA OFF',
        'boost.repair': 'REPAIR',
    ...
    'pt-BR': {
        ...
        'account.copy': 'Use sua conta para salvar identidade e pontuacao global, ou continue como convidado nesta sessao.',
        ...
        'account.message.itchGuest': 'Versao itch: ranking online ativo em modo convidado.',
        ...
        'account.message.itchGuestOnly': 'No itch, o ranking online usa modo convidado.',
        ...
        'debug.slowCameraOn': 'CAMERA LENTA ON',
        'debug.slowCameraOff': 'CAMERA LENTA OFF',
        'boost.repair': 'REPARO',
        'boost.slow': 'TIME SHIFT',
        'boost.triple': 'TRIPLE JUMP',
        'boost.airDash': 'AIR DASH'
