...
const TRANSLATIONS = {
    en: {
        ...
        'start.tagline': 'Outrun the corruption. Set the record.',
        'start.difficulty': 'DIFFICULTY',
        'start.landscapeHint': 'BEST IN LANDSCAPE — ROTATE YOUR PHONE',
        'rotate.title': 'ROTATE YOUR DEVICE',
        'rotate.sub': 'AETHERIS runs in landscape',
        'pwa.install': 'INSTALL APP',
        'pwa.installAria': 'Install AETHERIS as an app',
    ...
    'pt-BR': {
        ...
        'start.play': 'INICIAR CORRIDA',
        'start.tagline': 'Fuja da corrupcao. Crave o recorde.',
        'start.difficulty': 'DIFICULDADE',
        'start.landscapeHint': 'MELHOR NA HORIZONTAL — GIRE O CELULAR',
        'rotate.title': 'GIRE O CELULAR',
        'rotate.sub': 'AETHERIS roda na horizontal',
        'pwa.install': 'INSTALAR APP',
        'pwa.installAria': 'Instalar AETHERIS como aplicativo',
